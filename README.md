...
- uses: rspack-contrib/rspack-toolchain/download-rspack-binding@v1.0.4-canary.0
  with:
    path: artifacts
...
```yaml
- uses: rspack-contrib/rspack-toolchain/get-napi-info@v1.0.4-canary.0
  with:
...
jobs:
  build:
    name: Build
    uses: rspack-contrib/rspack-toolchain/.github/workflows/build.yml@v1.0.4-canary.0
    with:
